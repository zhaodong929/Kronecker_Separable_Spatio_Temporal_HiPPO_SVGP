...
FACTORIAL_ROOT="$BASE/blocked_development_factorial_v4"
...
FAIRNESS_LOCK="$ROOT/baselines/covid_long_setting_b/BASELINE_FAIRNESS_PROTOCOL_4090_REPAIRED_V4.json"
FORMAL_ROOT="$ROOT/baselines/covid_long_setting_b/results/formal_repaired_4090_v4"
REPORT_ROOT="$ROOT/baselines/covid_long_setting_b/reports/formal_gaussian_repaired_4090_v4"
